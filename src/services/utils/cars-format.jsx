...
export function exportCarsToSpreadsheet(cars, fileName = "cars.xlsx") {
...
export async function spreadsheetToCars(file) {
    ...
    return data
        ...
        .filter((car) => car.id && car.brand && car.model && car.imageKey);
}